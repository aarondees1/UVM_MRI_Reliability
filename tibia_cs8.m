function [xyzo,xyzax,aspect,widt,height,xyzpt,prox_tib_x, prox_tib_y, prox_tib_ml,prox_tib_ap] = tibia_cs8(faxial, ...
                                                           leg,iplt);
...
%
xyzpt = xyzp(1:end-1,:);
prox_tib_x = sortrows(xyzpt,1);
prox_tib_y = sortrows(xyzpt,2);
prox_tib_ap = abs(prox_tib_x(1,1) - prox_tib_x(end,1)); % AP Dimension
prox_tib_ml = abs(prox_tib_y(1,2) - prox_tib_y(end,2)); % ML Dimesnion
