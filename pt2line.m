...
% Validate input dimensions: all inputs must be 1x3 row vectors.
...
% Compute the closest point on the line to the given point.
dp = pxyz-lpt0; % Vector from line's initial point to the given point
t = (lvec*dp')/(lvec*lvec'); % Parametric distance along line to closest point
xyzp = t*lvec+lpt0; % Coordinates of the closest point on the line
